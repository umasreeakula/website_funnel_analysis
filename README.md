...
- Users accessed the website via desktop more than mobile devices. 
- On average, about 22,600 users landed each month.
...
- Nearly 13% only proceeded to add a product and head to payment (Search > Payment).
- Only about 7.50% made a purchase (Payment > Confirmation).

-> There was a noticeable decrease in user sessions progressing from the Home page to the Search page, particularly in March and April, which led to a reduction in the conversion rate from an average of 60% in January and February to about an average of 40% in March and April. Similarly, the conversion rate from the Search to Payment page declined from approximately 18% in January and February to around 7% in March.

-> Notably, a significant drop in daily conversion rates started on March 1st.
- The conversion rate from Home to Search page decreased from 63% to 39%.
- There was also a decline in the conversion rate from Search to Payment, dropping from nearly 15% to 6.7%.

-> When comparing conversion rates across months by gender, female users generally showed slightly higher conversion rates than male users, but both groups followed a similar trend.

-> Additionally, when examining conversion rates across months by device type, it was observed that:
- Desktop users consistently had a conversion rate of nearly 50% from Home to Search. 
...
- Conversion to complete a purchase (Payment > Confirmation): mobile users slightly outperformed desktop users.
